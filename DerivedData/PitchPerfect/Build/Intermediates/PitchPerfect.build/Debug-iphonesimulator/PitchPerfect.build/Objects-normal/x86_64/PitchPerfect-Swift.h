...
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified snailButton;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified fastButton;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified stopButton;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified chipmunkButton;
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified darthvaderButton;
...
- (void)playWithPitch:(float)pitch;
- (void)playAudio:(AVAudioPlayer * __nullable)audioPlayer rate:(float)rate;
- (IBAction)playSnail:(UIButton * __nonnull)sender;
- (IBAction)playFast:(UIButton * __nonnull)sender;
- (IBAction)playChipmunk:(UIButton * __nonnull)sender;
- (IBAction)playDarthvader:(UIButton * __nonnull)sender;
- (IBAction)stopPlay:(UIButton * __nonnull)sender;
...
- (IBAction)stopRecord:(UIButton * __nonnull)sender;
